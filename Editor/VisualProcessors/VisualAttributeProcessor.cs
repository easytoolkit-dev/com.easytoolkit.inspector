...
{
    /// <summary>
    /// Abstract base class for visual element processors that handle specific attribute types.
    /// Provides a convenient way to access the associated attribute and validate element types.
    /// </summary>
    /// <typeparam name="TAttribute">The type of attribute this processor handles.</typeparam>
    [HandlerConstraints]
    public abstract class VisualAttributeProcessor<TAttribute> : VisualProcessor
        where TAttribute : Attribute
    {
        private TAttribute _attribute;

        /// <summary>
        /// Gets the logical element associated with this processor.
        /// </summary>
        public new ILogicalElement Element => (ILogicalElement)base.Element;

        /// <summary>
        /// Gets the attribute associated with this processor.
        /// </summary>
        ...
        protected override bool CanProcess(IElement element)
        {
            ...
            {
                return CanProcessElement(logicalElement);
            }
        ...
        /// <summary>
        /// Determines whether this processor can handle the specified logical element.
        /// Override this method to provide custom validation logic.
        /// </summary>
        /// <param name="element">The logical element to test.</param>
        /// <returns>True if this processor can handle the element; otherwise, false.</returns>
        protected virtual bool CanProcessElement(ILogicalElement element)
        {
            return true;
        }
    }
    ...
    /// <summary>
    /// Abstract base class for visual element processors that handle specific attribute types with value type constraints.
    ...
    [HandlerConstraints]
    public abstract class VisualAttributeProcessor<TAttribute, TValue> : VisualAttributeProcessor<TAttribute>
        where TAttribute : Attribute
    {
