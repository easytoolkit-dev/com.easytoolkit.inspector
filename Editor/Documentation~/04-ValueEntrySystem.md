...
**位置**: [Core/ValueEntry/Abstractions/IValueEntry.cs](../Core/ValueEntry/Abstractions/IValueEntry.cs)
...
**位置**: [Core/ValueEntry/Abstractions/IValueAccessor.cs](../Core/ValueEntry/Abstractions/IValueAccessor.cs)
...
- **接口**: [Core/ValueEntry/Abstractions/IValueAccessor.cs](../Core/ValueEntry/Abstractions/IValueAccessor.cs)
- **实现**: [Core/ValueEntry/Implementations/ValueEntry.cs](../Core/ValueEntry/Implementations/ValueEntry.cs)

## IValueState - 值状态

**位置**: [Core/ValueEntry/Abstractions/IValueState.cs](../Core/ValueEntry/Abstractions/IValueState.cs)
...
public interface IValueState
{
    ...
    ValueEntryState State { get; } // 值条目状态
...
- **接口**: [Core/ValueEntry/Abstractions/IValueState.cs](../Core/ValueEntry/Abstractions/IValueState.cs)
- **实现**: [Core/ValueEntry/Implementations/ValueEntry.cs](../Core/ValueEntry/Implementations/ValueEntry.cs)

## IValueChangeHandler - 值变化处理器

**位置**: [Core/ValueEntry/Abstractions/IValueChangeHandler.cs](../Core/ValueEntry/Abstractions/IValueChangeHandler.cs)
...
- **接口**: [Core/ValueEntry/Abstractions/IValueChangeHandler.cs](../Core/ValueEntry/Abstractions/IValueChangeHandler.cs)
- **实现**: [Core/ValueEntry/Implementations/ValueEntry.cs](../Core/ValueEntry/Implementations/ValueEntry.cs)
...
**位置**: [Core/Operations/IValueOperation.cs](../Core/Operations/IValueOperation.cs)
...
**位置**: [UI/Operations/MemberValueOperation.cs](../UI/Operations/MemberValueOperation.cs)

#### 2. UnityPropertyOperation

通过 Unity SerializedProperty 访问值。

**位置**: [UI/Operations/UnityPropertyOperation.cs](../UI/Operations/UnityPropertyOperation.cs)
...
- **接口**: [Core/Operations/IValueOperation.cs](../Core/Operations/IValueOperation.cs)
- **反射操作**: [UI/Operations/MemberValueOperation.cs](../UI/Operations/MemberValueOperation.cs)
- **Unity操作**: [UI/Operations/UnityPropertyOperation.cs](../UI/Operations/UnityPropertyOperation.cs)

## 集合元素操作 (ICollectionElementOperation)

**位置**: [Core/Operations/ICollectionElementOperation.cs](../Core/Operations/ICollectionElementOperation.cs)
...
**位置**: [UI/Operations/CollectionElement/ListElementOperation.cs](../UI/Operations/CollectionElement/ListElementOperation.cs)

#### 2. ReadOnlyListElementOperation

仅提供查询功能。

**位置**: [UI/Operations/CollectionElement/ReadOnlyListElementOperation.cs](../UI/Operations/CollectionElement/ReadOnlyListElementOperation.cs)

#### 3. UnityCollectionOperation

处理 Unity 序列化集合。

**位置**: [UI/Operations/Collection/UnityCollectionOperation.cs](../UI/Operations/Collection/UnityCollectionOperation.cs)
...
**位置**: [Core/Factories/ValueOperationResolverFactory.cs](../Core/Factories/ValueOperationResolverFactory.cs)

```csharp
public static class ValueOperationResolverFactory
{
    IValueOperationResolver CreateResolver(IElement element);
}
```

### 默认解析器

**位置**: [UI/Resolvers/OperationResolver/GenericValueOperationResolver.cs](../UI/Resolvers/OperationResolver/GenericValueOperationResolver.cs)
