...
**位置**: [Core/PostProcessor/IPostProcessor.cs](../Core/PostProcessor/IPostProcessor.cs)
...
**位置**: [UI/PostProcessors/PostProcessor.cs](../UI/PostProcessors/PostProcessor.cs)
...
**位置**: [Core/PostProcessor/PostProcessorChain.cs](../Core/PostProcessor/PostProcessorChain.cs)
...
**位置**: [Core/PostProcessor/PostProcessorPriorityAttribute.cs](../Core/PostProcessor/PostProcessorPriorityAttribute.cs)
...
**位置**: [UI/PostProcessors/GroupElementPostProcessor.cs](../UI/PostProcessors/GroupElementPostProcessor.cs)
...
GroupElementPostProcessor.Process()
    ...
    ├─→ 创建 GroupElement
    │    └─→ new GroupDefinition(...)
    │         └─→ ElementCreator.CreateGroupElement()
    │
    ├─→ 查找分组范围内的子元素
...
**位置**: [UI/PostProcessors/LogicalElementPostProcessor.cs](../UI/PostProcessors/LogicalElementPostProcessor.cs)
