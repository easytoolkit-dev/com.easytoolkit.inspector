...
│                      ElementTreeFactory                          │
│  ┌──────────────────────┐    ┌─────────────────────────┐        │
│  │   Definitions        │    │   ElementCreator        │        │
│  │ (Element Metadata)   │    │ (Element Creation)      │        │
│  └──────────────────────┘    └───────────┬─────────────┘        │
└──────────────────────────────────────────┼──────────────────────┘
                                             │
                                             ▼
...
### Resolver（解析器）
**位置**: [Core/Resolvers/](../Core/Resolvers/)
...
### EasyEditor
**位置**: [Editors/EasyEditor.cs](../Editors/EasyEditor.cs)

Unity Editor 的自定义 Inspector 扩展入口。

### EasyEditorWindow
**位置**: [Editors/EasyEditorWindow.cs](../Editors/EasyEditorWindow.cs)
