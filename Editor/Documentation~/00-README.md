...
1. **元素创建流程**: ElementTreeFactory → RootDefinition → ElementCreator → Element
...
- **工厂模式** - ElementTreeFactory, ElementCreator, ResolverFactory
- **责任链模式** - DrawerChain, PostProcessorChain
- **策略模式** - Resolver系统, Drawer系统
- **观察者模式** - 值变化事件
- **元数据模型** - ElementDefinition
- **组合模式** - Element树形结构
- **对象池模式** - 事件池

## 相关文件

- [../../../../AGENTS.md](../../../../AGENTS.md) - 项目开发规范和指南
