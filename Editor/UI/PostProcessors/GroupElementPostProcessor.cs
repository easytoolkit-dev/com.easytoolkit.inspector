...
namespace EasyToolkit.Inspector.Editor
{
    ...
    public class GroupElementPostProcessor : PostProcessor
    {
        ...
        private void ProcessImpl(ref int elementIndex)
        {
            ...
            var newGroupDefinition = new GroupDefinition(
                beginGroupAttributeType,
                beginGroupAttribute.GroupName,
                new[] { beginGroupAttributeInfo.Attribute });
            var newGroupElement = Element.SharedContext.Tree.ElementCreator.CreateGroupElement(newGroupDefinition);
