...
namespace EasyToolkit.Inspector.Editor
{
    ...
    /// Groups are abstract concepts for organizing elements, controlled by <see cref="Attributes.GroupAttribute"/> (e.g., <see cref="Attributes.FoldoutGroupAttribute"/>) and <see cref="Attributes.EndGroupAttribute"/>.
