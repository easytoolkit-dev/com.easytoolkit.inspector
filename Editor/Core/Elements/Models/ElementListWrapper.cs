...
namespace EasyToolkit.Inspector.Editor
{
    ...
    /// Delegates all operations to the underlying <see cref="ElementList{TBaseElement}"/> while
    ...
    {
        private readonly ElementList<TBaseElement> _baseList;
        ...
        public ElementListWrapper([NotNull] ElementList<TBaseElement> baseList)
            : base(baseList)
        {
        ...
        /// </summary>
        public new ElementList<TBaseElement> BaseList => _baseList;
