...
namespace EasyToolkit.Inspector.Editor
{
    ...
    /// Delegates all operations to the underlying <see cref="ElementList{TDerivedElement}"/> while
    ...
    {
        private readonly ElementList<TDerivedElement> _derivedList;
        ...
        public ElementListBoxedWrapper([NotNull] ElementList<TDerivedElement> derivedList)
            : base(derivedList)
        {
        ...
        /// </summary>
        public new ElementList<TDerivedElement> DerivedList => _derivedList;
